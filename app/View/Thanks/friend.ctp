    	...
    	<div class="<?php echo $odd ? "hstodd" : "hsteven" ?>">
        	<div class="time">
       		...
       		<div class="datas">
       			...
       			<?php elseif ($fb == $thank['Thank']['from_id']):?>
       				<?php /* あげたポイント */ ?>
	       			<img src="/cakephp/app/webroot/img/b0<?php echo $thank['Thank']['kinds']; ?>.png">
	       			<img src="/cakephp/app/webroot/img/yaji.gif">
...
<div id="LayoutDiv4">
    ...
    <div class="waku2">
        <div class="power">	
        <img src="/cakephp/app/webroot/img/t01.gif"><?php if (array_key_exists(0, $thanksByKind[0])) echo $thanksByKind[0][0]['count'] ?>
        <img src="/cakephp/app/webroot/img/t02.gif"><?php if (array_key_exists(0, $thanksByKind[1])) echo $thanksByKind[1][0]['count'] ?>
        <img src="/cakephp/app/webroot/img/t03.gif"><?php if (array_key_exists(0, $thanksByKind[2])) echo $thanksByKind[2][0]['count'] ?>
        <img src="/cakephp/app/webroot/img/t04.gif"><?php if (array_key_exists(0, $thanksByKind[3])) echo $thanksByKind[3][0]['count'] ?>
