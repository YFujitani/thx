    ...
    <?php foreach ($thanks as $thank): ?>
    	...
    	<div class="<?php echo $odd ? "hstodd" : "hsteven" ?>">
        	<div class="time">
       		...
       		<div class="datas" title="<?php echo $thank['Thank']['comment']; ?>">
       			<?php if ($fb == $thank['Thank']['to_id']):?>
       				<a style="text-decoration: none;" href="/cakephp/thanks/other?id=<?php echo $thank['Thank']['from_id']; ?>">
       			...
       			<?php elseif ($fb == $thank['Thank']['from_id']):?>
	       			<img src="/cakephp/app/webroot/img/b0<?php echo $thank['Thank']['kinds']; ?>.png">
	       			<img src="/cakephp/app/webroot/img/yaji.gif">
       				<a style="text-decoration: none;" href="/cakephp/thanks/other?id=<?php echo $thank['Thank']['to_id']; ?>">
